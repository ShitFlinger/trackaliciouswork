...
//            .instance(() -> PhysEntityTrackInstance::new, false)
    ...
    public static final BlockEntityEntry<WheelBlockEntity> TINY_WHEEL = REGISTRATE
            .blockEntity("tiny_wheel", WheelBlockEntity::tiny)
//            .instance(() -> PhysEntityTrackInstance::new, false)
            .validBlocks(TrackBlocks.TINY_WHEEL)
...
//            .instance(() -> PhysEntityTrackInstance::new, false)
    ...
    public static final BlockEntityEntry<WheelBlockEntity> MEDIUM_WHEEL = REGISTRATE
            .blockEntity("medium_wheel", WheelBlockEntity::medium)
//            .instance(() -> PhysEntityTrackInstance::new, false)
            .validBlocks(TrackBlocks.MEDIUM_WHEEL)
            .renderer(() -> SimpleWheelRenderer::new)
            .register();
...
//            .instance(() -> PhysEntityTrackInstance::new, false)
    ...
    public static final BlockEntityEntry<WheelBlockEntity> WAGON_WHEEL = REGISTRATE
            .blockEntity("wagon_wheel", WheelBlockEntity::wagon)
//            .instance(() -> PhysEntityTrackInstance::new, false)
            .validBlocks(TrackBlocks.WAGON_WHEEL)
            .renderer(() -> SimpleWheelRenderer::new)
            .register();
