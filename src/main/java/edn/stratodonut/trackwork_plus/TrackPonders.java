...
import edn.stratodonut.trackwork_plus.tracks.TrackPonderScenes;

public class TrackPonders {
    static final PonderRegistrationHelper HELPER = new PonderRegistrationHelper(trackwork_plusMod.MOD_ID);
