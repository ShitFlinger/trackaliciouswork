package edn.stratodonut.trackwork_plus.items;
...
public class TrackToolkitRenderer extends CustomRenderedItemModelRenderer {
    protected static final PartialModel OFFSET_WRENCH = new PartialModel(trackwork_plusMod.getResource("item/kit/power_wrench"));
    protected static final PartialModel SOCKET = new PartialModel(trackwork_plusMod.getResource("item/kit/socket"));
    protected static final PartialModel STIFFNESS_WRENCH = new PartialModel(trackwork_plusMod.getResource("item/kit/stiff_tool"));
