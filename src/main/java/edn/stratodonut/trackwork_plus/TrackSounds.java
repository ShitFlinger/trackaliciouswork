...
public class TrackSounds {
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS =
            DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, trackwork_plusMod.MOD_ID);
...
//    public static final RegistryObject<SoundEvent> TRACK_CREAK = registerSoundEvents("suspension_creak");
    ...
    private static RegistryObject<SoundEvent> registerSoundEvents(String name) {
        return SOUND_EVENTS.register(name, () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(trackwork_plusMod.MOD_ID, name)));
    }
