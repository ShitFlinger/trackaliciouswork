...
//        SuperByteBuffer cogs = CachedBufferer.partial(trackwork_plusPartialModels.COGS, state);
        SuperByteBuffer cogs = be.getWheelRadius() < 0.6f ?
                CachedBufferer.partial(trackwork_plusPartialModels.COGS, state) :
                be.getWheelRadius() > 0.8f ? CachedBufferer.partial(trackwork_plusPartialModels.LARGE_COGS, state) :
                    CachedBufferer.partial(trackwork_plusPartialModels.MED_COGS, state);
        cogs.centre()
