package edn.stratodonut.trackwork_plus.tracks.render.instance;
...
import edn.stratodonut.trackwork_plus.tracks.render.TrackBeltRenderer.ScalableScroll;
...
//        TrackBaseBlock.Part part = state.getValue(TrackBaseBlock.PART);
        if (part == TrackBaseBlock.TrackPart.MIDDLE) {
            PartialModel link = trackwork_plusPartialModels.TRACK_LINK;
//            parts.add()
...
//            topLink = CachedBufferer.partial(trackwork_plusPartialModels.TRACK_WRAP, state);
//            topLink.centre()
//                    .rotateY(yRot)
...
//        }
    ...
    private class TrackType implements Instanced<TrackPartData>{
        ...
        public BufferLayout getLayout() {
            return trackwork_plusInstanceFormats.TRACK;
        }
