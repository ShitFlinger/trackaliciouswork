package edn.stratodonut.trackwork_plus.tracks.render;
...
import edn.stratodonut.trackwork_plus.trackwork_plusPartialModels;
import edn.stratodonut.trackwork_plus.trackwork_plusSpriteShifts;
import edn.stratodonut.trackwork_plus.tracks.ITrackPointProvider;
import edn.stratodonut.trackwork_plus.tracks.blocks.TrackBaseBlock;
import edn.stratodonut.trackwork_plus.tracks.blocks.TrackBaseBlockEntity;
...
import static edn.stratodonut.trackwork_plus.tracks.ITrackPointProvider.PointType;
...
//        if (Backend.canUseInstancing(be.getLevel())) return;
    ...
    private static void renderLink(ITrackPointProvider fromTrack, float partialTicks,
        ...
        if (part == TrackBaseBlock.TrackPart.MIDDLE) {
            ...
            topLink.centre()
                    ...
                    .shiftUVScrolling(trackwork_plusSpriteShifts.BELT, scroll.getAtScale(1.0f))
                    .unCentre();
            ...
            flatlink.centre()
                    ...
                    .shiftUVScrolling(trackwork_plusSpriteShifts.BELT, scroll.getAtScale(0.5f))
                    .unCentre();
            ...
            topLink.centre()
                    ...
                    .shiftUVScrolling(trackwork_plusSpriteShifts.BELT, scroll.getAtScale(flip))
                    .unCentre();
            topLink.light(light).renderInto(ms, buf.getBuffer(RenderType.solid()));

            SuperByteBuffer wrapLink = CachedBufferer.partial(trackwork_plusPartialModels.TRACK_WRAP, state);
            wrapLink.centre()
                    .rotateY(yRot)
        ...
        if (fromTrack.getNextPoint() != PointType.NONE) {
            ...
            if (fromTrack.getNextPoint() == fromTrack.getTrackPointType()) {        // Middle
                ...
                link.centre()
                        ...
                        .shiftUVScrolling(trackwork_plusSpriteShifts.BELT, scroll.getAtScale(length))
                        .unCentre();
    ...
    public static class ScalableScroll {
        ...
        public ScalableScroll(KineticBlockEntity be, final float speed, Direction.Axis axis) {
            ...
            SpriteShiftEntry spriteShift = trackwork_plusSpriteShifts.BELT;
    ...
    private static SuperByteBuffer getLink(BlockState state) {
        return CachedBufferer.partial(trackwork_plusPartialModels.TRACK_LINK, state);
    }
