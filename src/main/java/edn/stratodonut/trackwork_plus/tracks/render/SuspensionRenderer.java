...
//            SuperByteBuffer wheels = CachedBufferer.partial(trackwork_plusPartialModels.SUSPENSION_WHEEL, state) ;
            SuperByteBuffer wheels = be.getWheelRadius() < 0.6f
                    ? CachedBufferer.partial(trackwork_plusPartialModels.SUSPENSION_WHEEL, state) :
                    be.getWheelRadius() > 0.8f ? CachedBufferer.partial(trackwork_plusPartialModels.LARGE_SUSPENSION_WHEEL, state) :
